package io.github.krys.nextrtp.common.asmbus.generator;

import io.github.krys.nextrtp.common.asmbus.dispatcher.EventDispatcher;
import io.github.krys.nextrtp.common.asmbus.event.Cancellable;
...
public class ASMEventDispatcherGenerator {
  ...
  public static <E extends Event> EventDispatcher<Event> generate(
    Class<E> eventType,
    ...
    String internalName = "io/github/krys/common/asmbus/generated/" + dispatcherName;
    String superName = "java/lang/Object";
    String[] interfaces = new String[]{EventDispatcher.class.getName().replace(".", "/")};
    ...
    Class<?> dispatcherClass = new EventBusClassLoader(ASMEventDispatcherGenerator.class.getClassLoader())
      .defineClass(internalName.replace('/', '.'), bytecode);
    ...
    return (EventDispatcher<Event>) dispatcherClass.getConstructor(constructorTypes).newInstance(constructorArgs);
  }
